export default function Payments() {
  return (
    <div className="space-y-4">
      <Header
        title="Payments"
        subtitle="View and reconcile customer payments across all invoices."
        actionLabel="Record Payment"
      />
      <Filters
        searchPlaceholder="Search invoice # / customer"
        statusOptions={["All", "Matched", "Unmatched", "Refunded"]}
      />
      <CardTable
        columns={["Date", "Reference", "Customer", "Method", "Amount", "Status"]}
        records={[
          ["2025-11-05", "PAY-001", "ABC Ltd.", "Bank Transfer", "৳ 25,000", "Matched"],
          ["2025-11-06", "PAY-002", "XYZ Traders", "Card", "৳ 15,000", "Unmatched"],
        ]}
      />
    </div>
  );
